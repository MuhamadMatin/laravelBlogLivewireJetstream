...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center pt-1 border-b-2 border-teal-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-teal-700 transition duration-150 ease-in-out'
